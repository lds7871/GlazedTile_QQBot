...
public class ConfigManager {
    ...
    public String getNapCatApiBase() {
        return getString("NapCatApiBase", "http://0.0.0.0:3000");
    }
    ...
    public String getWsUrlRemote() {
        return getString("WS_URL_REMOTE", "ws://0.0.0.0:3001");
    }
    ...
    public String getWsUrlSelect() {
        return getString("WS_URL_SELECT", "LOCAL");
    }
    ...
    public String getProxyHost() {
        return getString("proxy.host", "0.0.0.0");
    }
